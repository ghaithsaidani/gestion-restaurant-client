...
import {ChangePasswordFormModel} from "../../../public/shared/change-password-form.model";
    ...
    const mutation = useMutation({
        mutationFn: (data: ChangePasswordFormModel) =>
            AuthService.ChangePassword(data.password).then((response) => {
                const toast = {exist: true, message: "your password changed successfully", type: "success"}
